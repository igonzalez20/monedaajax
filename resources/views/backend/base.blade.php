...
<head>
  ...
  <title>moneda Backend | Dashboard</title>
  ...
  <!-- summernote -->
  <link rel="stylesheet" href="{{ url('assets/backend/plugins/summernote/summernote-bs4.css') }}">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{ url('assets/backend/dist/img/AdminLTELogo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">moneda Backend</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ url('assets/backend/dist/img/tiillo160.png') }}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview {{ $openmoneda ?? '' }}">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">s
                <a href="{{ url('backend/moneda') }}" class="nav-link {{ $viewOpenmoneda ?? '' }}"> {{-- if(isset($viewOpenmoneda)) $viewOpenmoneda else '' --}}
                  <i class="far fa-circle nav-icon"></i>
                  <p>View monedas</p>
                </a>
              </li>
              <li class="nav-item">
                {{-- GET show {{ url('backend/moneda/1') }} --}}
                {{-- GET show {{ route('backend.moneda.show',['moneda'  => 1]) }}  --}}
                <a href="{{ route('backend.moneda.create') }}" class="nav-link {{ $viewCreatemoneda ?? '' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Create monedas</p>
                </a>
              </li>
