...
<main role="main">
  <section class="jumbotron text-center">
    <div class="container">
      <h1>Index coins</h1>
      <p class="lead text-muted">En esta pagina os osfrecemos toda la informacio relacionada con los tickets disponibles ahora mismo en la web.</p>
      <p>
        <a href="{{ url('backend/') }}" class="btn btn-primary my-2">Backend</a>
      </p>
    </div>
  </section>
